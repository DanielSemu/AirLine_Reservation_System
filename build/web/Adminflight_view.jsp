...
<!--                        <th scope="col">Password</th> -->
                ...
                <tr>
                    ...
                    <td><a class="btn btn-success" href="#"id=<%=rs.getString("Flight_no")%>" role="button">Edit</a></td>
                    <td><a class="btn btn-danger" href="#"id=<%=rs.getString("Flight_no")%>" role="button">Remove</a></td>
                </tr>
                <% }%>
            </tbody>
        </table>
